...
description: Production-ready CSS transitions for web apps. Use when adding or replacing motion for badges, dropdowns, modals, panels, page changes, resizing cards, changing numbers or text, swapping icons, success and error feedback, avatar hovers, clearing inputs, skeletons, shimmer text, sliding tabs, tooltips, staggered reveals, card tilt, plus-to-menu morphs, accordions, collapsibles, or expand/collapse interactions. Triggers include "add a transition", "make it animate", "animate the dropdown", "open / close transition", "fade between", "page slide", "stagger animation", "success animation", "shake on invalid", "hover lift", "loading shimmer", "segmented control", "tooltip", "3D hover tilt", "FAB morph", "which transition fits here", and the commands transitions reveal or transitions apply. For reviewing and tuning existing motion tokens, durations, easing, or animation consistency, use the companion transitions-polish skill.
---
